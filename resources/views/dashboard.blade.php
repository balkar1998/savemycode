            ...
            <div class="col-md-3">
                <ul class="nav flex-column" id="sidebar">
                    ...
                    <div class="d-flex p-2 align-items-center folder-header">
                        ...
                        <button type="button" onclick="clearSearch()" style="background-color: transparent;">Clear Search</button>
                    </div>
                    ...
                    <li class="nav-item" id="folder_li">
                        <a class="nav-link ml-1" aria-current="page" style="display:flex;justify-content:space-between;align-items: center;" onclick="myFunction('{{$item->id}}')">
                            <div style="display: flex;"><img class="mr-5" src="{{ asset('image/folder.png') }}" width="30px" alt=""><span class="ml-2 folName">{{ $item->name }}</span></div><svg xmlns="http://www.w3.org/2000/svg" onclick="deleteFolder({{$item->id}})" style="width:15px" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
